...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Node.note'
        db.add_column('discourse_node', 'note',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['discourse.Note']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Node.note'
        db.delete_column('discourse_node', 'note_id')
